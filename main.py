...
class Node:    # Used for Linked list
...
class GUI(ttk.Window):
    def __init__(self):
        ...
        self.initProgram()
        self.currentFrame = self.mainPage
    ...
    def initViewPage(self):
        ...
        self.scheduleViewer.column("index", anchor="w", minwidth=40, width=40)
        self.scheduleViewer.column("module", anchor="w", minwidth=170, width=10)
        ...
        self.scheduleViewer.column("duration", anchor="w", minwidth=70, width=10)
        self.scheduleViewer.column("location", anchor="w", minwidth=60, width=10)
        ...
        self.scheduleViewer.heading("index", text="#", anchor="w")
        ...
        self.endTimeEntry.insert(0,"23:00")
    ...
    def displaySchedules(self):
        ...
        try:
            for index, schedule in enumerate(self.displayHandler.getResult()):
                li = schedule.data.getAll()
                li[7] = dayString[li[7]]
                li.insert(0,index+1)
                self.scheduleViewer.insert("", tk.END, value=li)
        except TypeError:
            if self.currentFrame is not self.loadPage:
